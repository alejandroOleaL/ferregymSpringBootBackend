package alejandroolea.netlifly.app.ferregym.backend.controllers;
...
import alejandroolea.netlifly.app.ferregym.backend.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) {
		...
		if(clienteActual == null) {
			response.put("mensaje", "Error, no se puede editar, el Cliente ID: ".concat(id.toString().concat(" no existe en la bd")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
